        ...
        <div class="row pt-5">
                ...
                <table class="table table-bordered table-hover small">
                    ...
                    <tbody>
                        <tr v-for="(p, index) in paginador(pacientes)" :key="index">
                            ...
                            <td align="center">
                            <div class="btn-group">
                                <button class="btn btn-info">Pautar</button>
                            </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="btn-block">
                            <button class="btn btn-default btn-lg btn-block" @click="btnRedirect('pacientes')">Pacientes</button>
                            <button class="btn btn-default btn-lg btn-block" @click="btnRedirect('monitores')">Monitores</button>
